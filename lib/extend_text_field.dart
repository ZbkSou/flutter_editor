...
typedef ChangeCallback = String Function(Diff diff, TextSelection selection);
...
class ExtendTextField extends StatefulWidget {
  ...
  final SpecialTextContentListNotifier? specialTextContentDataController;
  ///内容修改之后得回调
    ...
    Widget child = RepaintBoundary(
      child: UnmanagedRestorationScope(
        ...
        child: ExtendEditableText(
          ...
          specialTextContentDataController:widget.specialTextContentDataController,
